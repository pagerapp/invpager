...
export const zh: Dict = {
  ...
  evolution: {
      ...
      stages: [
        { name: "电子邮件", role: "01 / E-MAIL", prompt: "如何发送消息？", q: "信息传递。", body: "早期数字通信解决了核心问题：让信息跨越距离抵达人与人之间。关键变化是：消息不再依赖实体载体。" },
        { name: "短信", role: "02 / SMS", prompt: "如何更快联系？", q: "随时连接。", body: "移动短信让人们随时可达，也让交流更接近实时。关键变化是：联系变得更简单、更迅速。" },
        { name: "聊天、语音、视频", role: "03 / 聊天、语音、视频", prompt: "如何实时沟通？", q: "即时交流。", body: "即时通讯把多种交流方式汇聚在同一空间，让持续连接成为日常。关键变化是：交流变得不间断。" },
        { name: "多重档案", role: "04 / 多重档案", prompt: "如何选择联系形式？", q: "可控交流。", body: "PAGER 增加新的沟通层：不同档案、个性化规则，以及对每次互动方式的掌控。关键变化是：交流真正属于个人。" },
      ],
  ...
  product: {
    ...
    h: ["PAGER 已经", "投入使用"],
    lead: "核心产品模型已实现为完整可用的用户流程——从 PAGER ID 和连接请求，到身份选择、权限设置、私聊与群聊。",
    bridge: "可运行的产品，而非概念。",
    metrics: [
      { value: "14+", label: "已实现功能" },
      { value: "04", label: "沟通身份" },
    ],
    columns: [
      {
        title: "基础沟通",
        statement: "即时通信的基础已经搭建完成。",
        body: "注册、PAGER ID、搜索、连接请求、私聊与群聊共同构成一个完整流程。",
        items: ["注册", "PAGER ID", "按 ID 搜索", "连接请求", "一对一对话", "群聊"],
      },
      {
        title: "PAGER 核心机制",
        statement: "可控访问已经内置于产品之中。",
        body: "用户选择沟通身份、定义可用的联系方式，并可为特定联系人授予临时访问。",
        items: ["沟通身份", "为联系人选择身份", "个性化权限", "访客身份", "临时访问", "沟通方式管理"],
      },
      {
        title: "下一阶段",
        statement: "将 PAGER 扩展到私聊之外。",
        body: "后续版本将增加新的沟通形式，并把多身份机制带入公共空间。",
        items: ["音频和视频消息", "语音和视频通话", "公共频道", "公共频道中的多身份", "动态", "动态中的多身份", "高级隐私设置", "新的角色与访问场景"],
      },
    ],
    stories: [
      { title: "公共频道", statement: "一个频道，多种在场方式。", body: "用户可通过选定身份参与公共频道，在个人、工作和其他呈现方式之间保持分离。" },
      { title: "动态", statement: "通过选定身份发布短内容。", body: "用户可通过选定身份分享生活或工作动态，并控制哪些受众能够看到它们。" },
      { title: "临时访问", statement: "沟通不仅能由规则限制，也能由时间限制。", body: "访客身份可在限定时间内开放沟通，无需将临时联系人变成永久联系人。" },
      { title: "群聊", statement: "群体沟通已经属于 PAGER 的工作模型。", body: "用户可参与群组对话，同时保留选定的呈现方式和自己的沟通边界。" },
    ],
