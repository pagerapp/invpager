...
export const en: Dict = {
  ...
  nav: {
    ...
    meta: "MANAGED COMMUNICATION / 2026",
  ...
  product: {
    ...
    h: ["PAGER IS", "ALREADY WORKING"],
    lead: "The core product model is implemented as a working user journey — from PAGER ID and connection requests to profile selection, permissions, direct and group conversations.",
    bridge: "A WORKING PRODUCT, NOT A CONCEPT.",
    metrics: [
      { value: "14+", label: "implemented features" },
      { value: "04", label: "communication profiles" },
    ],
    columns: [
      {
        title: "FOUNDATIONAL COMMUNICATION",
        statement: "The messenger foundation is already in place.",
        body: "Registration, PAGER ID, search, connection requests, direct and group conversations work as one coherent journey.",
        items: ["Registration", "PAGER ID", "Search by ID", "Connection requests", "1:1 conversations", "Group chats"],
      },
      {
        title: "PAGER CORE MECHANIC",
        statement: "Controlled access is already built into the product.",
        body: "A user selects a communication profile, defines available connection modes and can grant temporary access to individual contacts.",
        items: [
          "Communication profiles",
          "Profile selection for a contact",
      ...
      {
        title: "NEXT STAGE",
        statement: "We are extending PAGER beyond direct conversations.",
        body: "The next versions add new communication formats and bring multiprofile mechanics into public spaces.",
        items: ["Audio and video messages", "Voice and video calls", "Public channels", "Multiprofile in public channels", "Moments", "Multiprofile in Moments", "Advanced privacy settings", "New roles and access scenarios"],
      },
    ],
    stories: [
      { title: "PUBLIC CHANNELS", statement: "One channel — different ways to be present.", body: "A user will be able to participate in public channels through a selected profile, preserving separation between personal, work and other ways of representing themselves." },
      { title: "MOMENTS", statement: "Short posts from a selected profile.", body: "A user will be able to share moments from life or work through a selected profile and control which audience sees them." },
      { title: "TEMPORARY ACCESS", statement: "A connection can be limited by time as well as by rules.", body: "A guest profile makes it possible to open communication for a limited period without turning a temporary contact into a permanent one." },
      { title: "GROUP CHATS", statement: "Group communication is already part of PAGER's working model.", body: "A user can take part in group conversations while preserving their chosen representation and personal communication boundaries." },
    ],
